...
@SuppressLint("NewApi")
public class ClientViewPropertyAnimator extends Animator implements
        AnimatorListener {
    enum Properties {
        TRANSLATION_X, TRANSLATION_Y, SCALE_X, SCALE_Y, ROTATION_Y, ALPHA, START_DELAY, DURATION, INTERPOLATOR
    }

    private EnumSet<Properties> mPropertiesToSet = EnumSet
            .noneOf(Properties.class);
    ...
    public ClientViewPropertyAnimator(View target) {
        mTarget = target;
    ...
    public void start() {
        ...
        ClientAnimUtils.cancelOnDestroyActivity(this);
    }

    public ClientViewPropertyAnimator translationX(float value) {
        mPropertiesToSet.add(Properties.TRANSLATION_X);
        mTranslationX = value;
        return this;
    }

    public ClientViewPropertyAnimator translationY(float value) {
        mPropertiesToSet.add(Properties.TRANSLATION_Y);
        mTranslationY = value;
        return this;
    }

    public ClientViewPropertyAnimator scaleX(float value) {
        mPropertiesToSet.add(Properties.SCALE_X);
        mScaleX = value;
        return this;
    }

    public ClientViewPropertyAnimator scaleY(float value) {
        mPropertiesToSet.add(Properties.SCALE_Y);
        mScaleY = value;
        return this;
    }

    public ClientViewPropertyAnimator rotationY(float value) {
        mPropertiesToSet.add(Properties.ROTATION_Y);
        mRotationY = value;
        return this;
    }

    public ClientViewPropertyAnimator alpha(float value) {
