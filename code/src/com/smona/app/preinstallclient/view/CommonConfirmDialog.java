...
public class CommonConfirmDialog extends Dialog {
	...
	public CommonConfirmDialog(Context context, int resId, Handler handler, String title_text, String line1_text, String buttonOkText, String buttonReturnText) {
		super(context, R.style.commonDialog);
		this.handler = handler;
		this.resId = resId;
		...
		this.setOnKeyListener(new OnKeyListener() {
			...
			public boolean onKey(DialogInterface dialogInterface, int keyCode, KeyEvent event) {
				if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
					if (handler != null && checkBoxRead != null && checkBoxRead.isChecked()) {
