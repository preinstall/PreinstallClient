...
public class Element extends LinearLayout implements OnDownListener {
	...
	private void initDatas() {
		...
		STATUS_MAPS.put(DownloadProxy.STATUS_RUNNING, R.string.download_downloading);
		...
		STATUS_MAPS.put(DownloadProxy.STATUS_SUCCESSFUL, R.string.download_install);
	}
	...
	public void onProgress(int progress) {
		...
		LogUtil.d(TAG, "onProgress getProgressTotal:  " + mProgress.getProgressTotal() + "onProgress progress:  " + progress);
	}
	...
	public void initUI(ItemInfo info) {
		...
		IconCache iconCache = ((ClientApplication) context.getApplicationContext()).getIconCache();
