	...
	public static List<ItemInfo> queryDBDatas(Context context) {
		...
		try {
			...
			if (canRead) {
				...
				int appClassIndex = c.getColumnIndex(ClientSettings.ItemColumns.APPCLASS);
				int appIconUrlIndex = c.getColumnIndex(ClientSettings.ItemColumns.APPICONURL);
				int appNameIndex = c.getColumnIndex(ClientSettings.ItemColumns.APPNAME);
				int appSizeIndex = c.getColumnIndex(ClientSettings.ItemColumns.APPSIZE);
				int appUrlIndex = c.getColumnIndex(ClientSettings.ItemColumns.APPURL);
